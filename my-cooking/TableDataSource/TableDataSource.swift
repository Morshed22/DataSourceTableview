...
public class TableDataSource: NSObject {
    ...
    /// Initializes the datasource with the provided sections (that may contain rows)
    ...
    /// Initializes the datasource with the provided rows (one default Section will be created)
    ...
    /// Updates the datasource with the provided sections
    ...
    /// Updates the datasource with rows (one default Section with empty header and footer will be created)
